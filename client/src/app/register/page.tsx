      ...
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Sign up to start planning your next travel itineraries
          </p>
        </div>
        ...
        <div className="border border-white/10 rounded-2xl bg-slate-900/50 backdrop-blur-xl p-8 shadow-xl shadow-slate-950/50">
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link href="/login" className="font-semibold text-blue-400 hover:text-blue-300 hover:underline transition-all">
              Sign In
            </Link>
          </div>
        </div>
